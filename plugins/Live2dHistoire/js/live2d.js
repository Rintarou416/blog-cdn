...
function(t) {
    ...
    $.prototype.normalizePartsOpacityGroup = function(t, e, i) {
        ...
        for (n = 0; n < e.length; n++) if (! ((s = e[n].partsIndex) < 0)) if (r == n) t.setPartsOpacity(s, o);
            ...
            var a, h = t.getPartsOpacity(s); (1 - (a = o < .5 ? -.5 * o / .5 + 1 : .5 * (1 - o) / .5)) * (1 - o) > .15 && (a = 1 - .15 / (1 - o)),
            h > a && (h = a),
    ...
    p.prototype.update = function() {
        ...
        if (0 != this.lastTimeSec) {
            ...
            if (! (Math.abs(o) <= this.EPSILON && Math.abs(n) <= this.EPSILON)) {
                ...
                a = t * o / s - this.faceVX,
                h = _ - this.faceVY,
                l = Math.sqrt(a * a + h * h); (l < -r || l > r) && (a *= r / l, h *= r / l, l = r),
                this.faceVX += a,
                this.faceVY += h;
...
function(t, e, i) {
    ...
    default.VIEW_MIN_SCALE), (b = new L.L2DMatrix44).multScale(1, e / i), (C = new L.L2DMatrix44).multTranslate( - e / 2, -i / 2), C.multScale(2 / e, -2 / e), O = v(), (0, A.setContext)(O), !O) return console.error("Failed to create WebGL context."),
        ...
        function() {
                ...
                if (0 != i) if (1 == t.length) {
                    ...
                    for (f = 0; f < t.length; f++) {
                        ...
                        if (o == f) s.setPartsOpacity(h, n);
                            ...
                            var u, p = s.getPartsOpacity(h); (1 - (u = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (u = 1 - .15 / (1 - n)),
                            p > u && (p = u),
            ...
            i.prototype.findSameClip = function(t) {
                for (var e = 0; e < this.clipContextList.length; e++) {
                    ...
                    if (r == t.length) {
                        for (var o = 0,
                        n = 0; n < r; n++) for (var s = i.clipIDList[n], _ = 0; _ < r; _++) if (t[_] == s) {
                            o++;
                            break
                        }
                        if (o == r) return i
            ...
            i.prototype.setupLayoutBounds = function(t) {
                ...
                n = 0; n < i.CHANNEL_COUNT; n++) {
                    ...
                    $.layoutBounds.height = 1;
                        ...
                        $.layoutBounds.height = 1
                    } else if (s <= 4) for (h = 0; h < s; h++) l = ~~ (l = h % 2),
                    a = ~~ (a = h / 2),
                    ($ = this.clipContextList[o++]).layoutChannelNo = n,
                    $.layoutBounds.x = .5 * l,
                    $.layoutBounds.y = .5 * a,
            ...
            S._$Vr = function(t, e, i, r, o, n, s, _) {
                ...
                if (a <= 0) {
                    ...
                    else for (g = 0; g < $;) n[u] = p[g++],
                    n[u + 1] = p[g++],
                    u += _
                } else if (1 == a) for (var p = o[h[0]], f = o[h[1]], c = l[0], d = 1 - c, g = 0; g < $;) n[u] = p[g] * d + f[g] * c,
                ++g,
                n[u + 1] = p[g] * d + f[g] * c,
                ++g,
                u += _;
                else if (2 == a) for (var p = o[h[0]], f = o[h[1]], y = o[h[2]], m = o[h[3]], c = l[0], T = l[1], d = 1 - c, P = 1 - T, S = P * d, v = P * c, L = T * d, E = T * c, g = 0; g < $;) n[u] = S * p[g] + v * f[g] + L * y[g] + E * m[g],
                ++g,
                n[u + 1] = S * p[g] + v * f[g] + L * y[g] + E * m[g],
                ++g,
                u += _;
                else if (3 == a) for (var M = o[h[0]], I = o[h[1]], w = o[h[2]], x = o[h[3]], O = o[h[4]], D = o[h[5]], R = o[h[6]], F = o[h[7]], c = l[0], T = l[1], b = l[2], d = 1 - c, P = 1 - T, C = 1 - b, N = C * P * d, B = C * P * c, U = C * T * d, G = C * T * c, Y = b * P * d, k = b * P * c, V = b * T * d, X = b * T * c, g = 0; g < $;) n[u] = N * M[g] + B * I[g] + U * w[g] + G * x[g] + Y * O[g] + k * D[g] + V * R[g] + X * F[g],
                ++g,
            ...
            F.prototype.transform = function(t, e, i) {
                ...
                default:
                    return;
                case F._$go | F._$fo | F._$gb: for (r = this._$7, o = this._$H, n = this._$k, s = this._$f, _ = this._$g, a = this._$w; --i >= 0;) {
                        var $ = t[h++],
                        u = t[h++];
                        e[l++] = r * $ + o * u + n,
                        e[l++] = s * $ + _ * u + a
                    ...
                    return;
                case F._$go | F._$fo: for (r = this._$7, o = this._$H, s = this._$f, _ = this._$g; --i >= 0;) {
                        var $ = t[h++],
                        u = t[h++];
                        e[l++] = r * $ + o * u,
                        e[l++] = s * $ + _ * u
                    ...
                    return;
                case F._$go | F._$gb: for (o = this._$H, n = this._$k, s = this._$f, a = this._$w; --i >= 0;) {
                        $ = t[h++];
                        e[l++] = o * t[h++] + n,
                        e[l++] = s * $ + a
                    }
                ...
                case F._$go:
                    ...
                    return;
                case F._$fo | F._$gb: for (r = this._$7, n = this._$k, _ = this._$g, a = this._$w; --i >= 0;) e[l++] = r * t[h++] + n,
                    e[l++] = _ * t[h++] + a;
                    return;
                case F._$fo:
            ...
            G.prototype.update = function() {
                ...
                r = this._$aS.length,
                o = H._$or(),
                n = H._$Pr() - o + 1; (null == this._$Ws || this._$Ws.length < n) && (this._$Ws = new Int16Array(n), this._$Vs = new Int16Array(n));
                for (e = 0; e < n; e++) this._$Ws[e] = G._$V2,
                this._$Vs[e] = G._$V2; (null == this._$Er || this._$Er.length < r) && (this._$Er = new Int16Array(r));
                ...
                T = o; T < u; T += n) {
                    ...
                    if (v = e[T], L = e[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        if ( - 2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
                            ...
                            b = f - 2 * y,
                            C = p - 2 * c - 2 * g,
                            N = f - 2 * d - 2 * y; (B = .5 * (v - -2)) + (U = .5 * (L - -2)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
                        } else if (L >= 1) {
                            var F = s[2 * (0 + a * E)],
                            b = s[2 * (0 + a * E) + 1],
                            C = p - 2 * c + 1 * g,
                            ...
                            O = f + 3 * y,
                            D = p - 2 * c + 3 * g,
                            R = f - 2 * d + 3 * y; (B = .5 * (v - -2)) + (U = .5 * (L - 1)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
                        } else { (k = 0 | S) == a && (k = a - 1);
                            var B = .5 * (v - -2),
                            U = S - k,
                            G = k / a,
                            ...
                            N = f + 1 * d - 2 * y,
                            F = p + 3 * c - 2 * g,
                            b = f + 3 * d - 2 * y; (B = .5 * (v - 1)) + (U = .5 * (L - -2)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
                        } else if (L >= 1) {
                            var C = s[2 * (_ + a * E)],
                            N = s[2 * (_ + a * E) + 1],
                            F = p + 3 * c + 1 * g,
                            ...
                            R = f + 1 * d + 3 * y,
                            x = p + 3 * c + 3 * g,
                            O = f + 3 * d + 3 * y; (B = .5 * (v - 1)) + (U = .5 * (L - 1)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
                        } else {
                            var k = 0 | S;
                            k == a && (k = a - 1);
                            var B = .5 * (v - 1),
            ...
            (tt.prototype = new
            function() {}).getPartsOpacity = function() {
                return this._$VS
            },
...
function(t, e, i) {
    ...
    function o() {
        ...
        this.reloadFlg = !1,
        Live2D.init(),
        n.Live2DFramework.setPlatformManager(new s.
    default)
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
...
default = o;
    ...
    default.DEBUG_LOG && console.log("Tap face."), this.models[i].setRandomExpression()) : this.models[i].hitTest(a.
...
default = o;
    ...
    s = r(i(11)),
    _ = r(i(1)),
    a = r(i(3)); (o.prototype = new n.L2DBaseModel).load = function(t, e, i) {
        this.setUpdating(!0),
                    ...
                    function() {
                        if (r.isTexLoaded) {
                            ...
                            if (null != r.modelSetting.getHitAreasCustom()) {
                                ...
                                null != n.head_x && (_.
                            default.hit_areas_custom_head_x = n.head_x),
                                null != n.head_y && (_.
                            default.hit_areas_custom_head_y = n.head_y),
                                null != n.body_x && (_.
                            default.hit_areas_custom_body_x = n.body_x),
                                null != n.body_y && (_.
    ...
    o.prototype.update = function() {
        ...
        default.PRIORITY_SLEEPY):
            (this.startRandomMotion(_.
        default.MOTION_GROUP_Talk, _.
        default.PRIORITY_FORCE), document.getElementById("live_talk").value = "0")),
            this.mainMotionManager.isFinished() && "0" === e && ("1" === sessionStorage.getItem("Sleepy") ? sessionStorage.getItem("Sleepy") : (this.startRandomMotion(_.
        default.MOTION_GROUP_Reset, _.
        default.PRIORITY_IDLE), "0" === document.getElementById("live_talk").value && (document.getElementById("live_talk").value = "3"))),
